...
SECRET_KEY = 'rfs+dcgwvvd))cxc=cg6#2u0uf!8af%ad7#z@6pv9*!eid-z-5'
...
INSTALLED_APPS = [
    'django.contrib.sites',#changed this line
    'allauth',#changed this line
    'allauth.account',#changed this line
    'allauth.socialaccount',#changed this line 
